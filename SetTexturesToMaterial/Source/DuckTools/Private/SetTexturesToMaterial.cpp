...
#define LOCTEXT_NAMESPACE "FDuckTools"

void FSetTexturesToMaterial::StartupModule()
{
...
void FSetTexturesToMaterial::ShutdownModule()
{
	// This function may be called during shutdown to clean up your module.  For modules that support dynamic reloading,
	// we call this function before unloading the module.
}

TSharedRef<FExtender> FSetTexturesToMaterial::AssetToolsExtender(const TArray<FAssetData>& SelectedAssets)
{
...
void FSetTexturesToMaterial::AssetToolsExtenderFunc(FMenuBuilder& MenuBuilder, const TArray<FAssetData> SelectedAssets)
{
	MenuBuilder.BeginSection("Tom's Asset Tools", LOCTEXT("TOMS_ASSET_TOOLS_CONTEXT", "Tom's Asset Tools"));
	{
		...
		if (!SelectedTextureAssets.IsEmpty())
		{
			MenuBuilder.AddMenuEntry(
				...
				/*FUIAction(FExecuteAction::CreateRaw(this, &FSetTexturesToMaterial::SetTexturesToMaterialInstance, SelectedAssets)),*/
...
void FSetTexturesToMaterial::SetTexturesToMaterialInstance(TArray<FAssetData> SelectedTextureAssets)
{
	...
	for (FAssetData SelectedAsset : SelectedTextureAssets)
	{
		...
		UMaterialInterface* MasterMaterial{ Cast<UMaterialInterface>(EditorAssetSubsystem->LoadAsset("/DuckTools/SetTexturesToMaterial/M_Master")) };
...
IMPLEMENT_MODULE(FSetTexturesToMaterial, SetTexturesToMaterial)